...
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fexceptions', '-fstack-protector-strong', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fexceptions', '-fstack-protector-strong', '-m64', '-mtune=generic', '-fPIC', '-fwrapv', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['ipv6', 'energy', 'error-model', 'stats', 'socket', 'routing', 'udp', 'realtime', 'naming', 'tutorial', 'wireless', 'tcp', 'matrix-topology', 'udp-client-server', 'traffic-control']
...
NS3_EXECUTABLE_PATH = ['/extra/nnguy072/cs169lab/ns-allinone-3.25/ns-3.25/build/src/fd-net-device', '/extra/nnguy072/cs169lab/ns-allinone-3.25/ns-3.25/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.8.5', '/extra/nnguy072/cs169lab/ns-allinone-3.25/ns-3.25/build']
...
cfg_files = ['/extra/nnguy072/cs169lab/ns-allinone-3.25/ns-3.25/build/ns3/config-store-config.h', '/extra/nnguy072/cs169lab/ns-allinone-3.25/ns-3.25/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
