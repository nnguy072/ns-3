...
#ifndef nPARF_WIFI_MANAGER_H
#define nPARF_WIFI_MANAGER_H

#include "wifi-remote-station-manager.h"

namespace ns3 {

struct nParfWifiRemoteStation;
/**
 * \ingroup wifi
 ...
 *
 */
class nParfWifiManager : public WifiRemoteStationManager
{
public:
  /**
   * Register this type.
...
private:
   ...
   */
  void CheckInit (nParfWifiRemoteStation *station);
